...
SAVE_FILE = os.path.join(os.path.dirname(__file__), "dash_save.json")
...
class Level:
    ...
    def _make_pattern(self):
        ...
        x = WIDTH + 200
        # Add a sequence of patterns
        for section in range(50):
            gap = rng.randint(220, 420)
            # sometimes add a cluster of single tall block or spikes
            if rng.random() < 0.25:
                # cluster of spikes
